...
interface MapboxRouteLayerProvider : RouteLayerProvider {
    ...
    override fun initializePrimaryRouteLayer(
        ...
        val routeLineColorExpressions = listOf(color(lineColor))
    ...
    override fun initializePrimaryRouteShieldLayer(
        style: Style,
        scale: Float,
        lineColor: Int
    ): LineLayer {
    ...
    override fun initializeAlternativeRouteShieldLayer(
        style: Style,
        scale: Float,
        lineColor: Int
    ): LineLayer {
