...
interface RouteLayerProvider {
    fun initializePrimaryRouteShieldLayer(style: Style, scale: Float, color: Int): LineLayer
    fun initializeAlternativeRouteShieldLayer(style: Style, scale: Float, color: Int): LineLayer
